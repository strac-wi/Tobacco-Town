...
;; Set population-density --> allows manual setting of population density if switch set to "ON"
  ...
  (ifelse
     ...
     town-type = "Urban Rich" [ set population-density 24 ]
  )
...
;; Set workplace-density
 ...
 ;; Set School density
  ...
  if town-type = "Urban Rich" [
    let wage-proportions  [0.01	0.035	0.077	0.13	0.187	0.246	0.303	0.412	0.504	0.585	0.654	0.714	0.763	0.84	0.892	0.928	0.967 1 ]
    generate-smokers  wage-proportions 0.7847 0.8204 0.947
    generate-outlet-type  "Retailer" orange 28.16 8.38 0.921 7.74
  ]
...
to generate-outlet-type [ t-name t-color t-prop  t-dist-l t-dist-m t-dist-r  ]
    create-outlets ( round ( (world-width * world-height / 100 ) * random-normal t-prop 0.5 )) [
...
<experiments>
  ...
  <experiment name="QuantTest" repetitions="4" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>run-fast</go>
    <metric>average-costs</metric>
    <metric>end-density</metric>
