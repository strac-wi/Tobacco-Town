...
Note: The global minimum value is always the first local minimum value found UNLESS the smoker is willing to buy packs. This creates cases where the global minimum is the price at the next increment of quantity that is divisible by 10. For instance,if the local minimum is 14 and the smoker buys packs, then it is possible that the global minimum is at a quantity of 20 (2 packs).
@#$#@#$#@
default
true
0
