...
to add-outlets
  gis:create-turtles-from-points retailers outlets [
    ...
    while [result < 7.74] [ set result random-normal 8.38 0.947 ]
    if result > 7.74
    [set price result]
  ]
  ask outlets with [BusinessTy = "Public House" or BusinessTy = "Nightclub"] [die] ;; Pubs and Clubs no longer sell tobacco
...
;; Wage cumulative proportions - Data from National Income Distributions 2018
  ...
  set wage-proportions-list [ 0.01	0.035	0.077	0.13	0.187	0.246	0.303	0.412	0.504	0.585	0.654	0.714	0.763	0.84	0.892	0.928	0.967 1 ] ;; this is new
...
<experiments>
  <experiment name="experiment" repetitions="3" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="retailer-density-cap" first="30" step="5" last="100"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
