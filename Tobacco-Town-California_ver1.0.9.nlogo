...
;  generate-schools
  ...
  if town-type = "Suburban Poor" [
    ...
    ifelse override-rates? = false and override-wages? = false [
      (ifelse
        smokers-parameters = "Random (V rates)" [generate-smokers-V-rate  wage-proportions 0.9306  0.987  0.9817 "all"]
        smokers-parameters = "Random (V inventory)" [generate-smokers-V-inventory  wage-proportions 0.9306  0.987  0.9817 "all"]
        smokers-parameters = "Random (V wage)" [generate-smokers-V-wage  wage-proportions 0.9306  0.987  0.9817 "all"]
        smokers-parameters = "Random (V transport)" [generate-smokers-V-transport  wage-proportions 0.9306  0.987  0.9817 "all"]
    ...
    [
      (ifelse
        smokers-parameters = "Random (V rates)" [generate-smokers-V-rate  wage-proportions 0.9306  0.987  0.9817 "left" generate-smokers-V-rate  wage-proportions 0.9306  0.987  0.9817 "right"]
        smokers-parameters = "Random (V inventory)" [generate-smokers-V-inventory  wage-proportions 0.9306  0.987  0.9817 "left" generate-smokers-V-inventory  wage-proportions 0.9306  0.987  0.9817 "right"]
        smokers-parameters = "Random (V wage)" [generate-smokers-V-wage  wage-proportions 0.9306  0.987  0.9817 "left" generate-smokers-V-wage  wage-proportions 0.9306  0.987  0.9817 "right"]
        smokers-parameters = "Random (V transport)" [generate-smokers-V-transport  wage-proportions 0.9306  0.987  0.9817 "left" generate-smokers-V-transport  wage-proportions 0.9306  0.987  0.9817 "right"]
  ...
  if town-type = "Suburban Rich" [
    ...
    ifelse override-rates? = false and override-wages? = false [
      (ifelse
        smokers-parameters = "Random (V rates)" [generate-smokers-V-rate  wage-proportions 0.8697 0.8824 0.9231 "all"]
        smokers-parameters = "Random (V inventory)" [generate-smokers-V-inventory  wage-proportions 0.8697 0.8824 0.9231 "all"]
        smokers-parameters = "Random (V wage)" [generate-smokers-V-wage  wage-proportions 0.8697 0.8824 0.9231 "all"]
        smokers-parameters = "Random (V transport)" [generate-smokers-V-transport  wage-proportions 0.8697 0.8824 0.9231 "all"]
    ...
    [
      (ifelse
        smokers-parameters = "Random (V rates)" [generate-smokers-V-rate  wage-proportions 0.8697 0.8824 0.9231 "left" generate-smokers-V-rate  wage-proportions 0.8697 0.8824 0.9231 "right"]
        smokers-parameters = "Random (V inventory)" [generate-smokers-V-inventory  wage-proportions 0.8697 0.8824 0.9231 "left" generate-smokers-V-inventory  wage-proportions 0.8697 0.8824 0.9231 "right"]
        smokers-parameters = "Random (V wage)" [generate-smokers-V-wage  wage-proportions 0.8697 0.8824 0.9231 "left" generate-smokers-V-wage  wage-proportions 0.8697 0.8824 0.9231 "right"]
        smokers-parameters = "Random (V transport)" [generate-smokers-V-transport  wage-proportions 0.8697 0.8824 0.9231 "left" generate-smokers-V-transport  wage-proportions 0.8697 0.8824 0.9231 "right"]
  ...
  if town-type = "Urban Poor" [
    ...
    ifelse override-rates? = false and override-wages? = false [
      (ifelse
        smokers-parameters = "Random (V rates)" [generate-smokers-V-rate  wage-proportions 0.8797 0.892 0.9817 "all"]
        smokers-parameters = "Random (V inventory)" [generate-smokers-V-inventory  wage-proportions 0.8797 0.892 0.9817 "all"]
        smokers-parameters = "Random (V wage)" [generate-smokers-V-wage  wage-proportions 0.8797 0.892 0.9817 "all"]
        smokers-parameters = "Random (V transport)" [generate-smokers-V-transport  wage-proportions 0.8797 0.892 0.9817 "all"]
    ...
    [
      (ifelse
        smokers-parameters = "Random (V rates)" [generate-smokers-V-rate  wage-proportions 0.8797 0.892 0.9817 "left" generate-smokers-V-rate  wage-proportions 0.8797 0.892 0.9817 "right"]
        smokers-parameters = "Random (V inventory)" [generate-smokers-V-inventory  wage-proportions 0.8797 0.892 0.9817 "left" generate-smokers-V-inventory  wage-proportions 0.8797 0.892 0.9817 "right"]
        smokers-parameters = "Random (V wage)" [generate-smokers-V-wage  wage-proportions 0.8797 0.892 0.9817 "left" generate-smokers-V-wage  wage-proportions 0.8797 0.892 0.9817 "right"]
        smokers-parameters = "Random (V transport)" [generate-smokers-V-transport  wage-proportions 0.8797 0.892 0.9817 "left" generate-smokers-V-transport  wage-proportions 0.8797 0.892 0.9817 "right"]
  ...
  if town-type = "Urban Rich" [
    ...
    ifelse override-rates? = false and override-wages? = false [
      (ifelse
        smokers-parameters = "Random (V rates)" [generate-smokers-V-rate  wage-proportions 0.7847 0.8204 0.947 "all"]
        smokers-parameters = "Random (V inventory)" [generate-smokers-V-inventory  wage-proportions 0.7847 0.8204 0.947 "all"]
        smokers-parameters = "Random (V wage)" [generate-smokers-V-wage  wage-proportions 0.7847 0.8204 0.947 "all"]
        smokers-parameters = "Random (V transport)" [generate-smokers-V-transport  wage-proportions 0.7847 0.8204 0.947 "all"]
    ...
    [
      (ifelse
        smokers-parameters = "Random (V rates)" [generate-smokers-V-rate  wage-proportions 0.7847 0.8204 0.947 "left" generate-smokers-V-rate  wage-proportions 0.7847 0.8204 0.947 "right"]
        smokers-parameters = "Random (V inventory)" [generate-smokers-V-inventory  wage-proportions 0.7847 0.8204 0.947 "left" generate-smokers-V-inventory  wage-proportions 0.7847 0.8204 0.947 "right"]
        smokers-parameters = "Random (V wage)" [generate-smokers-V-wage  wage-proportions 0.7847 0.8204 0.947 "left" generate-smokers-V-wage  wage-proportions 0.7847 0.8204 0.947 "right"]
        smokers-parameters = "Random (V transport)" [generate-smokers-V-transport  wage-proportions 0.7847 0.8204 0.947 "left" generate-smokers-V-transport  wage-proportions 0.7847 0.8204 0.947 "right"]
  ...
  if town-type = "Urban Poor | Urban Rich" [
    ...
    let wage-proportions [0.078 0.154 0.318 0.452 0.632 0.786 0.892 0.966 0.991 1.0]
    (ifelse
      smokers-parameters = "Random (V rates)" [generate-smokers-V-rate  wage-proportions 0.8797 0.892 0.9817 "left"]
      smokers-parameters = "Random (V rates)" [generate-smokers-V-inventory  wage-proportions 0.8797 0.892 0.9817 "left"]
      smokers-parameters = "Random (V wage)" [generate-smokers-V-wage  wage-proportions 0.8797 0.892 0.9817 "left"]
      smokers-parameters = "Random (V transport)" [generate-smokers-V-transport  wage-proportions 0.8797 0.892 0.9817 "left"]
    ...
    (ifelse
      smokers-parameters = "Random (V rates)" [generate-smokers-V-rate  wage-proportions 0.7847 0.8204 0.947 "right"]
      smokers-parameters = "Random (V rates)" [generate-smokers-V-inventory  wage-proportions 0.7847 0.8204 0.947 "right"]
      smokers-parameters = "Random (V wage)" [generate-smokers-V-wage  wage-proportions 0.7847 0.8204 0.947 "right"]
      smokers-parameters = "Random (V transport)" [generate-smokers-V-transport  wage-proportions 0.7847 0.8204 0.947 "right"]
...
to generate-smokers-V-rate [t-wage-proportions t-car t-walk t-bike neighbourhood]
  ...
  if seed-A? = true [random-seed Seed-A]
  ask smokers with [my-neighbourhood = neighbourhood] [
    set discount (0.54 + random-float 0.46)
    set color white
    set shape "person"
...
to generate-smokers-VC-rate [t-wage-proportions t-car t-walk t-bike neighbourhood]
  ...
  ;; Smoking rate initialization
  if seed-A? = true [random-seed seed-A + N-runs]
  ask smokers with [my-neighbourhood = neighbourhood] [
    let random-number-smoke random-float 1.0
    let index-smoke 0
    ifelse override-rates? = false [
...
to generate-smokers-V-inventory [t-wage-proportions t-car t-walk t-bike neighbourhood]
...
to generate-smokers-V-wage [t-wage-proportions t-car t-walk t-bike neighbourhood]
...
to generate-smokers-V-transport [t-wage-proportions t-car t-walk t-bike neighbourhood]
...
Smokers-parameters
Smokers-parameters
"Random (V rates)" "Random rate (VC rates)" "Random (V inventory)" "Random inventory (VC inventory)" "Random (V wage)" "Random wage (VC wage)" "Random (V transport)" "Random transport (VC transport)" "Random (V routes)" "Random routes (VC routes)" "All random (ignore random-spatial?)"
3
...
1. Modified all the generate-smokers equations to follow a Monte Carlo approach:
	- The seeds used to generate the parameters in the V functions - `e.g. generate smokers V` - are the same accross the V function and the VC functions (except for the seeds used to generate the parameter under analysis in the VC function). Previously, a random seed generator was used leading to completely different sample parameters between V and VC which biased the results.
	- To exemplify, consider a 1000 run following a Monte Carlo sampling approach using the function `generate-smokers-VC-rates`. The smoking rates can be generated using the seed set S = {1, 2, 3, ... 1000}. In that case, the rest of the parameters musgt be generated using seeds that do not belong to the set S.
2. Added the following input paramters to apply point 1:
	- `seed-A` --> the base seed used in the VC functions for the parameter under analysis
	- `N-runs` --> the intended number of Monte Carlo runs. This parameter is added to the `seed-A` number in the VC functions to generate a new seed for the rest of the paramers. The same approach is used in the V functions for all the parameters.
	- `seed-A` --> whether the model should implement the seed-A values in the run or not
...
update-globals</go>
  ...
  <experiment name="uncertainy_monte carlo" repetitions="1" runMetricsEveryStep="false">
    <setup>setup
update-globals</setup>
    <go>run-fast
update-globals</go>
    ...
    <enumeratedValueSet variable="seed-A?">
      <value value="true"/>
    </enumeratedValueSet>
    <steppedValueSet variable="seed-A" first="1" step="1" last="3000"/>
    <enumeratedValueSet variable="N-runs">
      <value value="3000"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
